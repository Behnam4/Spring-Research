...
The equations for momentum conservation remain the same as non-relativistic case, so we have: I am using, the letter 
$P$ for momentum before the collision and the letter $Q$ for momentum after the collision. The scenario is 
for two particles which one of the stationary andf the other one is moving.

$
  \\
  \\
  \text{Momentum x-direction}: ~~~ P_1+0=Q_1 ~ cos\theta+Q_2 ~ cos \phi
  \\
  \\
  \text{Momentum y-direction}: ~~~ 0=Q_1 ~ sin\theta -Q_2 ~ sin \phi
  \\
  \\
 $
...
$
  ...
  \\
  \begin{cases}
    (2): ~~~ P_1-Q_1 ~ cos\theta=Q_2 ~ cos \phi
    \\
    \\
    (3): ~~~ Q_1 ~ sin\theta =Q_2 ~ sin \phi
  \end{cases}
  \\
  \\
$
...
$
  \\
  \begin{cases}
    P^2_1+Q^2_1 ~ cos^2 \theta-2 P_1 Q_1 cos \theta=Q^2_2 ~ cos^2 \phi
    \\
    \\
    Q^2_1 ~ sin^2\theta =Q^2_2 ~ sin^2 \phi
  \end{cases}
  \\
  \\
  \\
  P^2_1+Q^2_1 ~ cos^2 \theta-2 P_1 Q_1 cos \theta+Q^2_1 ~ sin^2\theta=Q^2_2 ~ cos^2 \phi+Q^2_2 ~ sin^2 \phi
  \\
  \\
  \\
  P^2_1+Q^2_1 ~ \bigg( sin^2\theta+cos^2 \theta \bigg)-2 P_1 Q_1 cos \theta=Q^2_2 \bigg( sin^2 \phi+cos^2 \phi \bigg)
  \\
  \\
  \\
  P^2_1+Q^2_1-2 P_1 Q_1 cos \theta=Q^2_2
  \\
  \\
$
...
$
  \\
  \\
  P^2_1 c^2+Q^2_1 c^2 -2 P_1 Q_1 c^2 cos \theta=Q^2_2 c^2
  \\
  \\
  \\
  P^2_1 c^2+Q^2_1 c^2 -2 P_1 Q_1 c^2 cos \theta=Q^2_2 c^2=\bigg( E_{tot}-E_3 \bigg)^2-\bigg( m_2 c^2 \bigg)^2 ~~~ \text{since } E^2=p^2c^2+m^2 c^4
  \\
  \\
  \\
  P^2_1 c^2+Q^2_1 c^2 -2 P_1 Q_1 c^2 cos \theta
  =E^2_{tot}+E^2_3-2 E_{tot} E_3-m^2_2 c^4
  \\
  \\
  \\
  P^2_1 c^2+\bigg( Q^2_1 c^2+m^2_2 c^4 \bigg)-2 P_1 Q_1 c^2 cos \theta
  =E^2_{tot}+E^2_3-2 E_{tot} E_3
  \\
  \\
  \\
  P^2_1 c^2+E^2_3-2 P_1 Q_1 c^2 cos \theta
  =E^2_{tot}+E^2_3-2 E_{tot} E_3
  \\
  \\
  \\
  P^2_1 c^2-2 P_1 Q_1 c^2 cos \theta
  =E^2_{tot}-2 E_{tot} E_3
  \\
  \\
  \\
  \therefore ~~~ E_3=\dfrac{
    E^2_{tot}+2 P_1 Q_1 c^2 cos \theta-P^2_1 c^2
  }{
    2 E_{tot}
  }
  \\
  ...
  \therefore ~~~ \boxed{
    E_3=\dfrac{
      E^2_{tot}+P^2_1 \bigg( 2 Q_1 cos \theta-1 \bigg)
    }{
      2 E_{tot}
    }
  } ~~~ \text{considering } c=1
  ...
  \therefore ~~~ \boxed{
    \begin{cases}
      ...
      \\
      \\
      Q_1=\sqrt{E^2_3-m^2_1}
      \\
      \\
      Q_2=\sqrt{E^2_4-m^2_2}
      \\
      \\
      \phi=Arcsin\bigg( \dfrac{Q_1}{Q_2} sin\theta \bigg)
    \end{cases}
  } ~~~~ \checkmark
$
...
$
  ...
  \\
  \\
  (T^2_i+2 m_i T_i) (1-cos \theta)=2 T_{\chi} \left[T_i+\dfrac{(m_i+m_{\chi})^2}{2 m_{\chi}}\right]
  \\
  \\
  \\
  T^2_i-T^2_i cos \theta+2 m_i T_i-2m_i T_i cos \theta=2 T_{\chi}T_i+2 T_{\chi} \dfrac{(m_i+m_{\chi})^2}{2 m_{\chi}}
  \\
  \\
  \\
  T^2_i-T^2_i cos \theta+2 m_i T_i-2m_i T_i cos \theta-2 T_{\chi}T_i-2 T_{\chi} \dfrac{(m_i+m_{\chi})^2}{2 m_{\chi}}=0
  \\
  \\
  \\
  \boxed{(1-cos \theta) T^2_i+2 \bigg(m_i -m_i cos \theta-T_{\chi}\bigg)T_i-T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}}=0}
  \\
  \\
  \\
  \begin{cases}
    ...
    \\
    \\
    b=2 \bigg(m_i -m_i cos \theta-T_{\chi}\bigg)
    \\
    \\
  ...
  \\
  T_i=\dfrac{
    -2 \bigg(m_i -m_i cos \theta-T_{\chi}\bigg) \pm \sqrt{\bigg( 2 (m_i -m_i cos \theta-T_{\chi}) \bigg)^2-4(1-cos \theta) \bigg( -T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}} \bigg) }
  }{
    2(1-cos \theta)
  }
  \\
  ...
  \\
  T_i=\dfrac{
    -2 \bigg(m_i -m_i cos \theta-T_{\chi}\bigg) \pm 2 \sqrt{\bigg(m_i -m_i cos \theta-T_{\chi}\bigg)^2-(1-cos \theta) \bigg( -T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}} \bigg) }
  }{
    2(1-cos \theta)
  }
  \\
  ...
  \\
  T_i=\dfrac{
    \bigg(T_{\chi}+m_i cos \theta-m_i\bigg) \pm \sqrt{\bigg(m_i -m_i cos \theta-T_{\chi}\bigg)^2+\bigg( 1-cos \theta \bigg)  \bigg(T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}} \bigg) }
  }{
    \bigg( 1-cos \theta \bigg) 
  }
  \\
  \\
  \\
  ...
  \\
  T_i=\dfrac{
    \bigg(T_{\chi}+m_i cos \pi-m_i\bigg) \pm \sqrt{\bigg(m_i-m_i cos \pi-T_{\chi}\bigg)^2+\bigg( 1-cos \pi \bigg)  \bigg(T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}} \bigg) }
  }{
    \bigg( 1-cos \pi\bigg) 
  }
  \\
  ...
  \\
  T_i=\dfrac{
    \bigg(T_{\chi}-m_i-m_i\bigg) \pm \sqrt{\bigg(2m_i-T_{\chi}\bigg)^2+\bigg( 1+1 \bigg)  \bigg(T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}} \bigg) }
  }{
    \bigg( 1+1 \bigg) 
  }
  \\
  ...
  \\
  T_i=\dfrac{
    \bigg(T_{\chi}-2m_i\bigg) \pm \sqrt{\bigg(2m_i-T_{\chi}\bigg)^2+ 2 T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}}}
  }{
    2 
  }
  \\
  \\
  \\
  2 T_i=\bigg(T_{\chi}-2m_i\bigg) \pm \sqrt{\bigg(2m_i-T_{\chi}\bigg)^2+ 2 T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}}}
  \\
  \\
  \\
  \dfrac{
  ...
  =\dfrac{
    \bigg(T_{\chi}-2m_i\bigg)
  }{
    \bigg(2m_i-T_{\chi}\bigg)
  }
  \pm\dfrac{
    \sqrt{\bigg(2m_i-T_{\chi}\bigg)^2+ 2 T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}}}
  }{
    \bigg(2m_i-T_{\chi}\bigg)
  }
  \\
  ...
  =-1 \pm \sqrt{\dfrac{\bigg(2m_i-T_{\chi}\bigg)^2+ 2 T_{\chi} \dfrac{(m_i+m_{\chi})^2}{m_{\chi}}}{\bigg(2m_i-T_{\chi}\bigg)^2}}
  \\
  \\
  \\
  \dfrac{2 T_i}{\bigg(2m_i-T_{\chi}\bigg)}
  =-1 \pm \sqrt{1+\dfrac{2 T_{\chi}}{m_{\chi}} \dfrac{\bigg( m_i+m_{\chi} \bigg)^2}{\bigg( 2m_i-T_{\chi} \bigg)^2}}
  \\
  \\
  \\
  2T_i=-\bigg( 2m_i-T_{\chi} \bigg) \pm \bigg(2m_i-T_{\chi}\bigg) \sqrt{1+\dfrac{2 T_{\chi}}{m_{\chi}} \dfrac{\bigg( m_i+m_{\chi} \bigg)^2}{\bigg( 2m_i-T_{\chi} \bigg)^2}}
  \\
  \\
  \\
  2T_i=\bigg( 2m_i-T_{\chi} \bigg) \left[ -1 \pm \sqrt{1+\dfrac{2 T_{\chi}}{m_{\chi}} \dfrac{\bigg( m_i+m_{\chi} \bigg)^2}{\bigg( 2m_i-T_{\chi} \bigg)^2}} \right]
  \\
  \\
  \\
  2T_i=\bigg( T_{\chi}-2m_i \bigg) \left[ 1 \pm \sqrt{1+\dfrac{2 T_{\chi}}{m_{\chi}} \dfrac{\bigg( m_i+m_{\chi} \bigg)^2}{\bigg( 2m_i-T_{\chi} \bigg)^2}} \right]
  \\
  \\
  \\
  \therefore ~~~ \boxed{
    T^{min}_i=\bigg( \dfrac{T_{\chi}}{2}-m_i \bigg) \left[ 1 \pm \sqrt{1+\dfrac{2 T_{\chi}}{m_{\chi}} \dfrac{\bigg( m_i+m_{\chi} \bigg)^2}{\bigg( 2m_i-T_{\chi} \bigg)^2}} \right]
  } ~~~~ \checkmark
$
