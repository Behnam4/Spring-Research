...
$
  ...
  \\
  \\
  v_{cmi} \bigg( 1+\dfrac{1}{2} \dfrac{v^2_{cmi}}{c^2} \bigg) ~ \dfrac{m_0+m_1}{m_2+m_3}=v_{cmf}+\dfrac{v^3_{cmf}}{2c^2}
  \\
  \\
  \\
  \begin{cases}
    \mathcal{S} \equiv v_{cmi} 2c^2 \bigg( 1+\dfrac{1}{2} \dfrac{v^2_{cmi}}{c^2} \bigg) ~ \dfrac{m_0+m_1}{m_2+m_3}
    \\
    \\
  ...
  \\
  \\
  \mathcal{X}^3+2c^2 \mathcal{X}-\mathcal{S}=0
  \\
  \\
  \\
  \text{We make } \mathcal{X}=p+q,
  \\
  \\
  \\
  \bigg( p+q \bigg)^3+2c^2 \bigg( p+q \bigg)-\mathcal{S}=0
  \Longrightarrow 
  p^3+q^3+3p^2q+3pq^2+2c^2 \bigg( p+q \bigg)-\mathcal{S}=0
  \\
  \\
  \\
  p^3+q^3+3pq \bigg( p+q \bigg)+2c^2 \bigg( p+q \bigg)-\mathcal{S}=0
  \\
  \\
  \\
  p^3+q^3+\bigg( 3pq+2c^2 \bigg) \bigg( p+q \bigg)-\mathcal{S}=0
  \\
  \\
  \\
  \text{We know impose that } 3pq+2c^2=0
  \Longrightarrow p^3+\bigg( \dfrac{-2c^2}{3 p} \bigg)^3-\mathcal{S}=0
  \\
  \\
  \\
  p^3+\bigg( \dfrac{-8c^6}{27 p^3} \bigg)^3-\mathcal{S}=0
  \\
  \\
  \\
  \text{This is just a a quadratic equation. There's only one variable now. So we might as well call } Z=p^3
  \\
  \\
  \\
  Z+\dfrac{-8c^6}{27 Z}-\mathcal{S}=0 \Longrightarrow \boxed{
    27 Z^2-27 \mathcal{S} Z-8c^6=0
  }
  \\
  \\
  \\
  Z=\dfrac{
    27 \mathcal{S} \pm \sqrt{729 \mathcal{S}^2-864 c^6}
  }{
    54
  }
$
...
\textbf{Direct detection constraints on light dark matter}
