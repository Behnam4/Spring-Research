...
than the speed of ligh, $\dfrac{v}{c} << 1$. Momentum conservation before and after the collision. Considering
...
$
  ...
  \\
  \\
  \text{Knowing } \dfrac{v}{c} << 1 
  \Longrightarrow
  \gamma=\dfrac{1}{\sqrt{1-\bigg( \dfrac{v}{c} \bigg)^2}} \approx \dfrac{1}{\sqrt{1-0}}=1
  \\
  \\
  \\
  \therefore ~~~ 1 \times ~ \bigg( m_0+m_1 \bigg)v_{cmi}=1 \times ~ \bigg( m_2+m_3 \bigg) v_{cmf}
  \\
  \\
  \\
  \therefore ~~~ \boxed{
