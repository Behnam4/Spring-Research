...
Assuming we are given $m_1, m_2, v_1,$ and $\theta_2$. Let's define  \textcolor{red}{$sin(\theta_2) \equiv \mathbf{S}, ~~ cos(\theta_2) \equiv \mathbf{C}$}.
...
$
  \\
  \begin{cases}
    m^2_1 ~ \textcolor{red}{\mathbf{U^2_1}} ~ cos^2(\theta_1)+m^2_2 ~ u^2_2 ~ \textcolor{red}{\mathbf{C^2}}=m^2_1 ~ v^2_{1}
    \\
    \\
    m^2_1 ~ \textcolor{red}{\mathbf{U^2_1}} ~ sin^2(\theta_1)-m^2_2 ~ u^2_2 ~ \textcolor{red}{\mathbf{S^2}}=0
  \end{cases}
  \\
  \\
  \rule{6cm}{1pt}
  \\
  \\
  m^2_1 ~ \textcolor{red}{\mathbf{U^2_1}} \left[cos^2(\theta_1)+sin^2(\theta_1)\right]+m^2_2 ~ u^2_2 \left(\textcolor{red}{\mathbf{C^2}}-\textcolor{red}{\mathbf{S^2}}\right)=m^2_1 ~ v^2_{1}
  \\
  \\
  \\
  m^2_1 \left[\textcolor{red}{\mathbf{U^2_1}}-v^2_1\right]+m^2_2 ~ u^2_2 \left(\textcolor{red}{\mathbf{C^2}}-\textcolor{red}{\mathbf{S^2}}\right)=0
  \\
  \\
  \\
  u^2_2=\dfrac{m^2_1 ~ \left(v^2_1-\textcolor{red}{\mathbf{U^2_1}}\right)}{m^2_2 ~ \left(\textcolor{red}{\mathbf{C^2}}-\textcolor{red}{\mathbf{S^2}}\right)}
  =\dfrac{m^2_1 ~ \left[v^2_1-\left(v^2_1-\dfrac{m_2}{m_1} ~ u^2_2\right) \right]}{m^2_2 ~ \left(\textcolor{red}{\mathbf{C^2}}-\textcolor{red}{\mathbf{S^2}}\right)}
$
