...
From $(1)$ and $(2)$ and by the Cramer's Rule we have:
...
$
  \\
  \begin{pmatrix}
    m_1 ~ u_1 && m_2 ~ cos(\theta_2)
    \\
    m_1 ~ u_1 && m_2 ~ sin(\theta_2)
  ...
  \Longrightarrow \begin{cases}
    cos(\theta_1)=\dfrac{m_1 ~ m_2 ~ v_1 ~ sin(\theta_2)-0}{m_1 ~ m_2 ~ u_1 ~ sin(\theta_2)-m_1 ~ m_2 ~ u_1 ~ cos(\theta_2)}
    \\
    \\
    u_2=-\dfrac{m_1^2 ~ u_1 ~ v_1}{m_1 ~ m_2 ~ u_1 ~ sin(\theta_2)-m_1 ~ m_2 ~ u_1 ~ cos(\theta_2)}
  \end{cases}
  \\
  \\
  \\
  \therefore ~~~ \boxed{
    \begin{cases}
      cos(\theta_1)=\dfrac{v_1}{u_1} \dfrac{sin(\theta_2)}{\bigg(sin(\theta_2)-cos(\theta_2)\bigg)}
      \\
      \\
      u_2=-\dfrac{m_1 ~ v_1}{m_2 \bigg(sin(\theta_2)-cos(\theta_2)\bigg)}
    \end{cases}
  } ~~~~ \checkmark
$
