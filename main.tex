...
$
  ...
  \\
  \therefore ~~~ \boxed{
    (7): ~ \dfrac{u_2}{u_1}=\dfrac{2m_1 ~ \textcolor{red}{\mathbf{K}}}{m_1-m_2}
  }
  \\
  \\
  \\
  ...
  \therefore ~~~ \boxed{
    u_2=\dfrac{
      2 m_1 ~ v_1 ~ \textcolor{red}{\mathbf{K}}
    }{
...
$
  ...
  =\dfrac{
    2 m_1 ~ v_1 ~ \left[cos(\theta_1) ~ cos(\theta_2)-sin(\theta_1) ~ sin(\theta_2)\right]
  }{
    \sqrt{\left(m_1-m_2\right)^2+4 m_1 ~ m_2 ~ \left[cos(\theta_1) ~ cos(\theta_2)-sin(\theta_1) ~ sin(\theta_2)\right]^2}
  }
  \\
  \\
  \\
  \begin{cases}
    f=2 m_1 ~ v_1 ~ \left[cos(\theta_1) ~ cos(\theta_2)-sin(\theta_1) ~ sin(\theta_2)\right]
    \\
    \\
    \\
    g=\sqrt{\left(m_1-m_2\right)^2+4 m_1 ~ m_2 ~ \left[cos(\theta_1) ~ cos(\theta_2)-sin(\theta_1) ~ sin(\theta_2)\right]^2}
    \\
    \\
    \\
    \dfrac{df}{d\theta_2}=-2m_1 ~ v_1 \left[cos(\theta_1) ~ sin(\theta_2)+sin(\theta_1) ~ cos(\theta_2)\right]
    \\
    \\
    \\
    \dfrac{dg}{d\theta_2}=-\dfrac{
      4m_1 ~ m_2 \left[cos(\theta_1) ~ sin(\theta_2)+sin(\theta_1) ~ cos(\theta_2)\right] \left[cos(\theta_1) ~ cos(\theta_2)-sin(\theta_1) ~ sin(\theta_2)\right]
    }{
      \sqrt{\left(m_1-m_2\right)^2+4 m_1 ~ m_2 ~ \left[cos(\theta_1) ~ cos(\theta_2)-sin(\theta_1) ~ sin(\theta_2)\right]^2}
    }
  \end{cases}
  ...
  \\
  \therefore ~~~ \begin{cases}
    f=2 m_1 ~ v_1 ~ cos(\theta_1+\theta_2)
    \\
    \\
    \\
    g=\sqrt{\left(m_1-m_2\right)^2+4 m_1 ~ m_2 ~ cos^2(\theta_1+\theta_2)}
    \\
    \\
    \\
    \dfrac{df}{d\theta_2}=-2m_1 ~ v_1 ~ sin(\theta_1+\theta_2)
    \\
    \\
    \\
    \dfrac{dg}{d\theta_2}=-\dfrac{
      4m_1 ~ m_2 ~ sin(\theta_1+\theta_2) ~ cos(\theta_1+\theta_2)
    }{
      \sqrt{\left(m_1-m_2\right)^2+4 m_1 ~ m_2 ~ cos^2(\theta_1+\theta_2)}
    }
  \end{cases}
  \\
  \\
  \\
  \therefore ~~~ \boxed{
    u_2=\dfrac{f}{g}, ~~~ \dfrac{d u_2}{d\theta_2}=\dfrac{\dfrac{df}{d\theta_2} ~ g-f ~ \dfrac{dg}{d\theta_2}}{g^2}
  }
  \\
  \\
  \\
  ...
  \\
  \\
  -2m_1 ~ v_1 ~ sin(\theta_1+\theta_2) ~ \sqrt{\left(m_1-m_2\right)^2+4 m_1 ~ m_2 ~ cos^2(\theta_1+\theta_2)}
  -2 m_1 ~ v_1 ~ cos(\theta_1+\theta_2) ~ -\dfrac{
    4m_1 ~ m_2 ~ sin(\theta_1+\theta_2) ~ cos(\theta_1+\theta_2)
  }{
    \sqrt{\left(m_1-m_2\right)^2+4 m_1 ~ m_2 ~ cos^2(\theta_1+\theta_2)}
  }
  \\
  \\
  \text{If} ~ \textcolor{red}{\sqrt{\left(m_1-m_2\right)^2+4 m_1 ~ m_2 ~ cos^2(\theta_1+\theta_2)} \equiv ~ \mathbf{W}} ~ \text{then}
  \\
  \\
  =-2m_1 ~ v_1 ~ sin(\theta_1+\theta_2) ~ \textcolor{red}{\mathbf{W}}
  -2 m_1 ~ v_1 ~ cos(\theta_1+\theta_2) ~ -\dfrac{
    4m_1 ~ m_2 ~ sin(\theta_1+\theta_2) ~ cos(\theta_1+\theta_2)
  }{
  ...
  \\
  \\
  =-2m_1 ~ v_1 \left[sin(\theta_1+\theta_2) ~ \textcolor{red}{\mathbf{W}}+ cos(\theta_1+\theta_2)\right]
  -\dfrac{4m_1 ~ m_2 ~ sin(\theta_1+\theta_2) ~ cos(\theta_1+\theta_2)}{\textcolor{red}{\mathbf{W}}}
  \\
  \\
  \\
  \rule{18cm}{1pt}
  ...
  \therefore ~~~ \boxed{
    \dfrac{d u_2}{d\theta_2}=\dfrac{
      -2m_1 ~ v_1 ~ \textcolor{red}{\mathbf{W}} \left[\textcolor{red}{\mathbf{W}} sin(\theta_1+\theta_2)+cos(\theta_1+\theta_2)\right]
      -4 m_1 ~ m_2 ~ sin(\theta_1+\theta_2) ~ cos(\theta_1+\theta_2)
    }{
      \textcolor{red}{\mathbf{W}}^2
    }
  } ~~~~ \checkmark
$
...
$
  \\
  \dfrac{d u_2}{d\theta_2}=0 \Longrightarrow -2m_1 ~ v_1 ~ \textcolor{red}{\mathbf{W}} \left[\textcolor{red}{\mathbf{W}} sin(\theta_1+\theta_2)+cos(\theta_1+\theta_2)\right]
  -4 m_1 ~ m_2 ~ sin(\theta_1+\theta_2) ~ cos(\theta_1+\theta_2)=0
  \\
  \\
  \\
  -2m_1 ~ v_1 ~ \textcolor{red}{\mathbf{W}} \left[\textcolor{red}{\mathbf{W}} sin(\theta_1+\theta_2)+cos(\theta_1+\theta_2)\right]
  ...
  \\
  \\
  -v_1 ~ \textcolor{red}{\mathbf{W}} \left[\textcolor{red}{\mathbf{W}} sin(\theta_1+\theta_2)+cos(\theta_1+\theta_2)\right]
  =4 ~ m_2 ~ sin(\theta_1+\theta_2) ~ cos(\theta_1+\theta_2)
$
